...
#include "job.pb-c.h"
void
job__init(Job *message)
{
    static Job init_value = JOB__INIT;
    *message = init_value;
}
size_t
job__get_packed_size(const Job *message)
{
...
size_t
job__pack(const Job *message, uint8_t *out)
{
    assert(message->base.descriptor == &job__descriptor);
    return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
}
size_t
job__pack_to_buffer(const Job *message, ProtobufCBuffer *buffer)
{
    assert(message->base.descriptor == &job__descriptor);
...
Job *
job__unpack(ProtobufCAllocator *allocator, size_t len, const uint8_t *data)
{
    return (Job *)protobuf_c_message_unpack(&job__descriptor, allocator, len,
                                            data);
}
void
job__free_unpacked(Job *message, ProtobufCAllocator *allocator)
{
    assert(message->base.descriptor == &job__descriptor);
